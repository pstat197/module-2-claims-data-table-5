...
### Results
As expected, Binary accuracy trumps multiclass by roughly 10%, yielding two trained models that effectively outperform preceding extended in-class analyses in predictive accuracy.
```{r,echo=FALSE}
