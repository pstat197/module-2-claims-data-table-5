...
### NOTE:
Adarsh Nagar had issues with keras and tensorflow in R. His code contributions were forwarded to another member to collaborate in the completion Preliminary Task 3 and otherwise Deliverable 2.
